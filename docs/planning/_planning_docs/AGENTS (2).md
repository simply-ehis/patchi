# AGENTS.md — Coding Agent Instructions (Ponytail Lazy Senior Dev)

> This file is for **coding agents** implementing features and fixes.
> For planning/review agents, see `mimocode.md`.
