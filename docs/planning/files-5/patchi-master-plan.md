...
3. **Domain taxonomy — anchored to existing standards, not invented:**
   ...
   - OWASP Top 10 for LLM Applications (relevant to Patchi's own brain and to LLM-integrated apps it scans)
   - OWASP Mobile Top 10
...
- License choice for Patchi (MIT/Apache-2.0 vs AGPL — AGPL worth weighing to discourage closed-source hosted forks)
