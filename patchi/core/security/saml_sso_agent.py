...
XXE_PATTERNS = [
    (r"resolve_entities\s*=\s*True", "XML entity resolution enabled"),
    (r"no_network\s*=\s*False", "Network access during XML parsing"),
    (r"DTDLOAD|dtd_load|load_dtd", "DTD loading enabled"),
    (r"ENTITY|entity|<!ENTITY", "XML entity declaration (potential XXE)"),
    (r"SYSTEM\s+[\"']", "XML SYSTEM entity reference"),
]

XSW_PATTERNS = [
    (r"cloneNode|importNode|appendChild.*Signature", "XML Signature Wrapping — node cloning"),
    (r"insertBefore.*Signature", "XML Signature Wrapping — insert before signature"),
    (r"getElementById.*Signature", "XML Signature Wrapping — ID reference"),
]
