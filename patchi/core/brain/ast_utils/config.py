...
EXEC_SINKS = {
    "execute", "exec", "eval", "execScript", "Runtime.getRuntime().exec",
    "subprocess.call", "subprocess.Popen", "subprocess.run",
    "subprocess.check_call", "subprocess.check_output",
    "os.system", "os.popen",
    "ProcessBuilder", "shell_exec", "system", "passthru", "exec_",
    "child_process.exec", "child_process.execSync", "child_process.spawnSync",
    "child_process.spawn", "child_process.execFile",
    "execSync", "spawnSync",
}

SQL_SINKS = {
    "execute", "execute_query", "executeQuery", "executeUpdate", "exec",
    "query", "raw_query", "prepare", "preparedStatement", "cursor.execute",
    "cursor.executemany", "db.execute", "session.execute", "EntityManager.createQuery",
    "entityManager.createQuery", "JdbcTemplate.query", "jdbcTemplate.query",
}
