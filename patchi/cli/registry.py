...
COMMANDS: list[Command] = [
    ...
    Command(
        ...
        subcommands=(
            ...
            Command("undo", "Undo last applied fix or specific patch",
                    "patchi.cli.commands.undo_cmd:run_undo",
                    args=(Arg("patch_id", nargs="?", help="Specific patch ID"),)),
            Command("redo", "Redo last undone fix or specific patch",
                    "patchi.cli.commands.undo_cmd:run_redo",
                    args=(Arg("patch_id", nargs="?", help="Specific patch ID"),)),
            Command("rollback", "Roll back to a specific patch",
    ...
    Command("chains", "Show exploit chains and intent gaps from last scan",
            ...
            args=(Arg("--min-score", type=float, default=0,
                  ...
                  Arg("--fix", action="store_true",
                      help="Apply auto-fixable remediations via RiskGate"),)),
    ...
    Command(
        ...
        namespace_handler=True,
        args=(
            Arg("goal", nargs="*", help="Natural-language goal, e.g. \"audit this project for security\""),
            Arg("--json", dest="json_output", action="store_true",
                help="Output the agent report as JSON"),
            Arg("--max-steps", dest="max_steps", type=int, default=6,
