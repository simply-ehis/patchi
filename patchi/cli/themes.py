...
PALETTES: dict[str, dict] = {
    ...
    "dark": _make(
        {
            "success": "bold green", "warn": "bold yellow", "error": "bold red",
            "info": "cyan", "muted": "dim",
            "heading": "bold white", "accent": "bold magenta",
            "path": "underline cyan", "count": "bold",
            "grade.a": "bold green", "grade.b": "green",
            "grade.c": "yellow", "grade.d": "bold yellow", "grade.f": "bold red",
            "sev.critical": "bold white on red", "sev.high": "bold red",
            "sev.medium": "yellow", "sev.low": "dim",
        },
        {"ok": "✓", "warn": "!", "err": "✗"},
    ),
    "light": _make(
        {
            "success": "bold green3", "warn": "bold dark_orange", "error": "bold red3",
            "info": "blue3", "muted": "grey50",
            "heading": "bold black", "accent": "bold purple3",
            "path": "underline blue3", "count": "bold",
            "grade.a": "bold green3", "grade.b": "green3",
            "grade.c": "dark_orange", "grade.d": "bold dark_orange", "grade.f": "bold red3",
            "sev.critical": "bold white on red3", "sev.high": "bold red3",
            "sev.medium": "dark_orange", "sev.low": "grey50",
        },
        {"ok": "✓", "warn": "!", "err": "✗"},
    ),
    ...
    "mono": _make(
        {
            "success": "none", "warn": "none", "error": "none",
            "info": "none", "muted": "none",
            "heading": "bold", "accent": "bold",
            "path": "underline", "count": "bold",
            "grade.a": "none", "grade.b": "none",
            "grade.c": "none", "grade.d": "none", "grade.f": "none",
            "sev.critical": "bold", "sev.high": "bold",
            "sev.medium": "none", "sev.low": "none",
        },
        {"ok": "[OK]", "warn": "[!]", "err": "[X]"},
    ),
    "highcontrast": _make(
        {
            "success": "bold bright_green", "warn": "bold bright_yellow",
            "error": "bold bright_red", "info": "bold bright_cyan", "muted": "white",
            "heading": "bold bright_white", "accent": "bold bright_magenta",
            "path": "underline bright_cyan", "count": "bold bright_white",
            "grade.a": "bold bright_green", "grade.b": "bright_green",
            "grade.c": "bold bright_yellow", "grade.d": "bold bright_yellow",
            "grade.f": "bold bright_red",
            "sev.critical": "bold bright_white on bright_red", "sev.high": "bold bright_red",
            "sev.medium": "bold bright_yellow", "sev.low": "white",
        },
        {"ok": "✓", "warn": "!", "err": "✗"},
    ),
}
