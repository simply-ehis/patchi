# AGENTS.md — Planning/Review Agent Instructions (Ponytail Lazy Senior Dev)

> This file is for **planning and review agents** analyzing scope and reviewing diffs.
> For coding agents, see `AGENTS (2).md`.
